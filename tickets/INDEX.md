...
| [T070](research/T070_pixel_roundtrip_validador_visual.md) | (r) | Pixel-roundtrip L0.5 — pipeline definido: macro SSIM + médio (Hungarian align + WER); micro descartado | `lab/e09_*` … `lab/e13_*` | A |
